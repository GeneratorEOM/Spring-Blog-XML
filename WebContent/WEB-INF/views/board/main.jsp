			...
			<div class="d-none d-md-block">
				<ul class="pagination justify-content-center">
					<c:choose>
						...
						<li class="page-item">
							<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageBean.currentPage - 1}" class="page-link">＜</a>
						</li>
						</c:when>
						<c:otherwise>
						<li class="page-item">
					...
					<c:choose>
						<c:when test="${idx eq pageBean.currentPage }">
					...
					<c:choose>
						<c:when test="${pageBean.currentPage == pageBean.pageCnt }">
						<li class="page-item disabled">
							<a href="#" class="page-link">＞</a>
						</li>
						<li class="page-item disabled">
